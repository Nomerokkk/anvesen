...
class Common {
    ...
    initUI() {
        ...
        $('[data-fancybox="modal-gallery"]').fancybox({
            ...
            btnTpl: {
                arrowLeft: '<button data-fancybox-prev class="modal-gallery-fancybox__arrow-left" title="{{PREV}}">' +
                '</button>',

                arrowRight: '<button data-fancybox-next class="modal-gallery-fancybox__arrow-right" title="{{NEXT}}">' +
                '</button>'
            },
